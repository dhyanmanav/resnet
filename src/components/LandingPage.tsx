import { GraduationCap, Users, BookOpen, MessageSquare, ArrowRight, FileText, Search } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 relative">
      ...
      <div className="relative z-10">
        {/* Navigation */}
        <nav className="border-b bg-white/90 backdrop-blur-sm fixed w-full z-50">
      ...
      <section className="py-20 px-6">
        ...
        {/* Footer */}
        <footer className="border-t bg-white/90 backdrop-blur-sm py-8 px-6">
          <div className="container mx-auto max-w-6xl text-center text-gray-600">
            <div className="flex items-center justify-center gap-2 mb-2">
              <img src={logoImage} alt="GAT Logo" className="w-8 h-8 object-contain" />
